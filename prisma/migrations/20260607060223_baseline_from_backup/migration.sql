...
-- CreateEnum
CREATE TYPE "comanda_status" AS ENUM ('ABERTA', 'AGUARDANDO_FECHAMENTO', 'FECHADA', 'CANCELADA');
...
-- CreateEnum
CREATE TYPE "produto_tipo" AS ENUM ('PRODUTO_SIMPLES', 'PRODUTO_COMPOSTO', 'INSUMO');
...
-- CreateEnum
CREATE TYPE "referencia_tipo" AS ENUM ('COMANDA', 'INVENTARIO', 'AJUSTE', 'ENTRADA_MANUAL');

-- CreateEnum
CREATE TYPE "unidade_produto" AS ENUM ('KG', 'L', 'UN');
...
-- CreateIndex
CREATE INDEX "idx_comanda_data_fechamento" ON "comandas"("data_fechamento");
...
-- CreateIndex
CREATE INDEX "idx_pagamento_forma" ON "pagamentos"("forma_pagamento");

-- CreateIndex
CREATE INDEX "idx_pagamento_data" ON "pagamentos"("data_pagamento");
...
-- AddForeignKey
ALTER TABLE "pagamentos" ADD CONSTRAINT "pagamentos_registrado_por_fkey" FOREIGN KEY ("registrado_por") REFERENCES "usuarios"("id") ON DELETE SET NULL ON UPDATE CASCADE;
